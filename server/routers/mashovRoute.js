const { getStudentAttendance, getStudentTests, getStudentAssignments, createTest, getAllStudents, createLesson, getAllStudentsByCourse, studentInfoByCourse, getTeacherCourses, getLastThree } = require("../controllers/mashovController");
...
router.get("/lastThree/:userId", getLastThree)
